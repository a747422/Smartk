...
public class BabyMoreActivity extends Fragment implements BabyMoreViewAdapter.ItemOnClickListener {
        ...
        if (!SharedPreferenceUtil.getStringData("pwd").equals("")) {
            ...
            x.http().post(requestParams, new Callback.CommonCallback<String>() {
                ...
                public void onSuccess(String result) {
                    ...
                    babyMoreViewAdapter = new BabyMoreViewAdapter(getActivity(), list, R.layout.home_baby_more_item, BabyMoreActivity.this);
        ...
        if (days >= 7) {
            ...
            x.http().post(requestParams, new Callback.CommonCallback<String>() {
                ...
                public void onSuccess(String result) {
                    ...
                    // end = (int) Float.parseFloat(json.get("expireTime").toString()) / 1000;
                    Log.d(TAG, Integer.valueOf(json.get("expireTime").toString()) + "");
                    //插入数据库
