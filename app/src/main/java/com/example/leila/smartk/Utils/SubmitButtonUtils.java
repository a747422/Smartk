...
public class SubmitButtonUtils extends View {
    ...
    public SubmitButtonUtils(Context context) {
        this(context, null);
    }

    public SubmitButtonUtils(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SubmitButtonUtils(Context context, AttributeSet attrs, int defStyleAttr) {
